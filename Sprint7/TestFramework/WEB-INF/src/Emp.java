package etu1936.framework.modele;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.*;
import etu1936.framework.annotation.*;
import etu1936.framework.ModeleView;
import etu1936.framework.ModeleView;
public class Emp{
    int empno;
    ...
    public ModeleView  Add_Emp(){
       // System.out.println("Nom : Rakoto");
        ...
        listDept.add(new Dept(1, "dept 1"));
        listDept.add(new Dept(2, "Departement 2"));
        ModeleView v= new ModeleView();
        v.setView("newEmp.jsp");
        v.addItem("listdept", listDept);
        System.out.println(v.getView());
        return v;
